# This file contains a class responsible for extracting
# the minutiae points of a fingerprint: location and orientation
# of terminations and bifurcations, another class to store the extracted
# informtion and a method that utilizes the two Classes above.
