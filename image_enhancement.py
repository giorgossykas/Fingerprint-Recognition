# This file contains two classes responsible for enhancing
# a fingerprint image (making it look like a contact-based fingerprint).
# "FingerprintImageEnhancer" Class enhances the image and
# "ProcessEnhance" Class, which inherits everything from the former Class,
# takes a raw color image, resizes, binarizes, applies a mask and then
# passes it to the other Class's methods to be enhanced.
# The "process" method from the "ProcessEnhance" Class returns
...
class FingerprintImageEnhancer(object):
    ...
    def enhance(self, img, resize=True): ##########################################################################
        # If images is less than 350x350 change resize to False and
        # then change to the suited dimensions.
